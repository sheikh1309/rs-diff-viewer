...
impl FileTree {
    ...
    pub fn view(&self) -> Element<Message> {
        ...
        let header_container_content = row![get_text_element("All Changes".to_string(), 32.0, main_white_color), row![].width(Length::Fill), accept_all_btn]
        ...
        let analysis_container_content = iced::widget::column![
            get_text_element("ANALYSIS SUMMARY".to_string(), 16.5, Color::from_rgb8(0xFF, 0xCC, 0x4D)),
        ...
        let analysis_style = |_theme: &Theme| {
            container::Style {
                ...
                border: Border { color: Color::from_rgb8(0xff, 0x57, 0x57), width: 2.0, radius: 12.0.into() },
                shadow: Default::default(),
            }
        };
        ...
        let root_bg_style = |_theme: &Theme| {
            let linear = Linear {
                angle: iced::Radians(0.0), // 0 degrees for "to right"
                stops: [
                    Some(iced::gradient::ColorStop { offset: 0.0, color: Color::from_rgb8(0x24, 0x24, 0x3e) }), // #24243e
                    Some(iced::gradient::ColorStop { offset: 0.5, color: Color::from_rgb8(0x30, 0x2b, 0x63) }), // #302b63
                    Some(iced::gradient::ColorStop { offset: 1.0, color: Color::from_rgb8(0x0f, 0x0c, 0x29) }), // #0f0c29
                    None,
                    None,
                    None,
                    None,
